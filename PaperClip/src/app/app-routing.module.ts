import { FlashcardGroupListComponent } from 'app/flashcards/+flashcard-group-list/flashcard-group-list.component';
...
const routes: Routes = [
  ...
  { path: 'flashcard-list/:groupKey', component:FlashcardGroupListComponent, canActivate: [AuthGuard]},
  { path: '**', redirectTo: '' },
];
